...
kc.init({
  onLoad: 'login-requred', // Supported values: 'check-sso' , 'login-required'
    ...
    <div className="App">
      <div className='grid'>
        <div className='col-12'>
          <h1>Nagehub a hoş geldiniz</h1>
          <a href="http://localhost:3001/">- Aura -</a>
          <div></div>
        </div>
      </div>
      <div className="grid">
